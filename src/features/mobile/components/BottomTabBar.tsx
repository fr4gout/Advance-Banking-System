import { CreditCard, FileText, Home, Send, Users } from "lucide-react";
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active ? "rounded-2xl bg-[var(--bg-row-alt)] text-primary" : "text-[var(--tx-3)]",
              )}
            >
              <Icon
                className={cn(
                ...
                style={active ? { transitionTimingFunction: "var(--mobile-spring)" } : undefined}
              />
