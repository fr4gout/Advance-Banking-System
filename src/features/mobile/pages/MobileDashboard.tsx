      ...
      <div className="flex min-h-0 flex-1 flex-col gap-4">
        ...
        <div className="mobile-stagger-4 shrink-0">
          <div className="grid grid-cols-4 gap-2">
            <MobileQuickAction icon={Send} label="Send" onClick={() => setTab("transfer")} />
            <MobileQuickAction icon={ArrowDownToLine} label="Request" onClick={openRequest} />
            <MobileQuickAction icon={Receipt} label="Bills" onClick={() => setTab("invoices")} />
            <MobileQuickAction icon={CreditCard} label="Cards" onClick={() => setTab("cards")} />
          </div>
        </div>
